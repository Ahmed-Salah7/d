        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title m-0">{{ __('page.relays_list') }}</h4>
                    </div>
                    <div class="col-md-4">
                        <div class="float-right">
                            <div class="dropdown">
                                <button class="btn btn-primary add-relay" type="button" data-title="{{ __('page.add_relay') }}">
                                    <i class="ti-plus mr-1"></i> {{ __('page.add_relay') }}
                                </button>
                            </div>
                        </div>
                    </div>
...
{{--                                    <div class="input-group-append bg-custom b-0"><span class="input-group-text"><i class="mdi mdi-calendar"></i></span></div>--}}
                ...
                <div class="card-body">
                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tr>
                            ...
                            <th> {{ __('page.contract_number') }}</th>
                            <th> {{ __('page.customer') }}</th>
                            <th> {{ __('page.date_deportation') }}</th>
                            <th> {{ __('page.airport') }}</th>
    ...
    <div class="modal fade bs-example-modal-lg relay-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
...
@section('js')
        ...
        $( document ).ready( function(){
            ...
            $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'date_deportation', name: 'date_deportation' },
    ...
    show: true
            ...
            $( document ).on( 'click',".edit-relay",function( event ) {
                var title = $(this).data('title');
                $('.modal-title').text(title);
                $(".modal-spinner").show();
                $('.result').html("");
    ...
    show: true
            ...
            $( document ).on( "click",".delete-relay",function( event ) {
            ...
            $( document ).on( "submit","#update_relay",function( event ) {
                event.preventDefault();
                $(".print-error-msg").css('display','none');
                $(".print-success-msg").css('display','none');
                //define variation
