                                ...
                                <div class="p-2">
                                    <form method="POST" id="reset_password">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                               <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ $email ?? old('email') }}" placeholder="{{ __('page.email') }}" required autofocus>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-12">
                                        ...
                                        <div class="form-group text-center row m-t-20">
                                            <div class="col-12">
                                                <button class="btn btn-primary btn-block waves-effect waves-light" type="submit">{{ __('page.reset_password') }}  <i class="fas "></i></button>
                                            </div>
                                        </div>
                                    </form>
                                    <!-- end form -->
