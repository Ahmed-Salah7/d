    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title m-0">{{ __('page.status_list') }}</h4>
                </div>
                <div class="col-md-4">
                    <div class="float-right">
                        <div class="dropdown">
                          <!--   <a href="{{ url('offices/create') }}"> -->
                                <button class="btn btn-primary add-status" type="button" data-title="{{ __('page.add_status') }}">
                                    <i class="ti-plus mr-1"></i> {{ __('page.add_status') }}
                                </button>
                           <!--  </a> -->
                        </div>
                    </div>
        ...
        <div class="card m-b-30">
            ...
            <div class="card-body">
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                    <tr>
                        <th width="60%"> {{ __('page.name') }}</th>
                        <th width="20%"> {{ __('page.office_type') }}</th>
                        <th width="20%"> {{ __('page.nationality') }}</th>
                        <th width="20%"> {{ __('page.action') }}</th>
                    </tr>
                    </thead>
                </table>
            </div>
...
<div class="modal fade bs-example-modal-lg status-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
...
<script type="text/javascript">
    $( document ).ready( function(){
        ...
        //status code
        $( document ).on( 'click',".add-status",function( event ) {
    ...
    show: true
        ...
        $( document ).on( "submit","#add_status",function( event ) {
            ...
            errors = statusValidation(formObj,errors);
    ...
    function statusValidation(formObj,errors){
        //remove error class
        ...
        var officeTypeObj = formObj.find('select[name="office_type"]');
        var officeType    = officeTypeObj.val();
        ...
        if( officeType =="" ) {
            errors = 1;
            officeTypeObj.addClass('parsley-error');
        }
